...
{
    public class MD : ResourceRecord
    {
        public String Hostname { get; private set; }

        internal MD(ManagementObject wmiRecord, String ServerName)
        {
            base.UpdateProperties(wmiRecord);
            base.ServerName = ServerName;
            base.RecordType = RecordType.MD;

            this.Hostname = (String)wmiRecord.Properties["MDHost"].Value;
        }
